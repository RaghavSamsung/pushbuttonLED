...
MOSAPI int MOSCConv mos_snprintf(char *, size_t, MOS_PRINTF_FORMAT const char *, ...);
...
MOSAPI int MOSCConv mos_kvprintf(char const *, void (*)(int, void*), void *, int,
  va_list);
MOSAPI int MOSCConv mos_sscanf(const char *, char const *, ...);
MOSAPI int MOSCConv mos_vsscanf(const char *, char const *, va_list);

MOSAPI int MOSCConv mos_printf(MOS_PRINTF_FORMAT const char *, ...);
MOSAPI int MOSCConv mos_printef(MOS_PRINTF_FORMAT const char *, ...);
...
/* error printing */
MOSAPI int MOSCConv mos_printe(const char *, ...);
...
MOSAPI int MOSCConv mos_asprintf(char **, uint32_t *, const char *, ...);
