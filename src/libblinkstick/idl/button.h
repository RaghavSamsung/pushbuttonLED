...
struct CarStateSeq;
#ifndef NDDS_STANDALONE_TYPE
class CarStateTypeSupport;
class CarStateDataWriter;
class CarStateDataReader;
#endif

class CarState 
{
  public:
    typedef struct CarStateSeq Seq;
    #ifndef NDDS_STANDALONE_TYPE
    typedef CarStateTypeSupport TypeSupport;
    typedef CarStateDataWriter DataWriter;
    typedef CarStateDataReader DataReader;
    #endif
